...
int atpyPass(double *rin, int num_particles, PyObject *element, struct parameters *param)
{
    ...
    double gap = py_get_double(element, "FullGap", false);
    double fint1 = py_get_double(element, "fringe_int_1", true);
    double fint2 = py_get_double(element, "fringe_int_2", true);
    long max_order = py_get_long(element, "max_order", true);
    long num_int_steps = py_get_long(element, "num_int_steps", true);
