...
class Element(object):
    ...
    def __init__(self, family_name, length=0, **kwargs):
...
class Marker(Element):
    ...
    def __init__(self, family_name, **kwargs):
        ...
        super(Marker, self).__init__(family_name, 0, **kwargs)
...
class Aperture(Element):
    ...
    def __init__(self, family_name, limits, **kwargs):
        ...
        super(Aperture, self).__init__(family_name, 0, **kwargs)
...
class Magnet(Element):
    ...
    def __init__(self, family_name, length, **kwargs):
        ...
        super(Magnet, self).__init__(family_name, length, **kwargs)
...
class Dipole(Magnet):
    ...
    def __init__(self, family_name, length, bending_angle, entrance_angle,
                 exit_angle, **kwargs):
        kwargs.setdefault('PassMethod', 'BndMPoleSymplectic4E2Pass')
        super(Dipole, self).__init__(family_name, length, **kwargs)
...
class Quadrupole(Magnet):
    ...
    def __init__(self, family_name, length, **kwargs):
        ...
        super(Quadrupole, self).__init__(family_name, length, **kwargs)
...
class Sextupole(Magnet):
    ...
    def __init__(self, family_name, length, **kwargs):
        ...
        super(Sextupole, self).__init__(family_name, length, **kwargs)
